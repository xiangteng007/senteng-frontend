...
const PaymentEditor = ({ payment, onSave, onBack, addToast }) => {
  ...
  const remainingAmount =
    formData.contractAmount - formData.previousPaidAmount - formData.requestAmount;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold">{payment?.paymentNo || '新增請款單'}</h2>
            {payment?.projectName && <p className="text-sm text-gray-500">{payment.projectName}</p>}
          </div>
        ...
        <div className="flex gap-2">
          ...
          {(payment?.status === PAYMENT_STATUS.INVOICED ||
        ...
        <div className="grid grid-cols-4 gap-4">
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({ ...prev, contractAmount: parseFloat(e.target.value) || 0 }))
              }
              disabled={!isEditable}
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({
                  ...prev,
                  previousPaidAmount: parseFloat(e.target.value) || 0,
                }))
              }
              disabled={!isEditable}
              className="w-full px-3 py-2 border rounded-lg text-right"
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({ ...prev, requestAmount: parseFloat(e.target.value) || 0 }))
              }
              disabled={!isEditable}
          ...
          <div>
            ...
            <input
              ...
              onChange={e =>
                setFormData(prev => ({ ...prev, retentionRate: parseFloat(e.target.value) || 0 }))
              }
              disabled={!isEditable}
              min="0"
              max="100"
...
const PaymentList = ({ onEdit, onBack, addToast }) => {
  ...
  return (
    <div className="space-y-6">
      {/* 標題 */}
      <div className="flex items-center justify-between">
        <SectionTitle icon={Receipt} title="請款管理" subtitle="管理專案請款與收款" />
        <button
...
const Payments = ({ addToast }) => {
  ...
  return <PaymentList onEdit={handleEdit} addToast={addToast} />;
};
