...
import {
  ...
  FinishCalculator,
  BuildingEstimator,
} from './MaterialCalculator/components';
  ...
  const renderCalculator = () => {
    switch (effectiveTab) {
      case 'structure':
        return (
          <StructureCalculator
            onAddRecord={(s, l, v, u, w, c) => addRecord('結構工程', s, l, v, u, w, c)}
            vendors={vendors}
      ...
      case 'masonry':
        return (
          <MasonryCalculator
            onAddRecord={(s, l, v, u, w, c) => addRecord('泥作工程', s, l, v, u, w, c)}
            vendors={vendors}
          />
        );
      case 'tile':
        return (
          <TileCalculator
            onAddRecord={(s, l, v, u, w, c) => addRecord('磁磚工程', s, l, v, u, w, c)}
            vendors={vendors}
          />
        );
      case 'finish':
        return (
          <FinishCalculator
            onAddRecord={(s, l, v, u, w, c) => addRecord('塗料工程', s, l, v, u, w, c)}
            vendors={vendors}
          />
        );
      case 'estimate':
        return (
          <BuildingEstimator
            onAddRecord={(s, l, v, u, w, c) => addRecord('建築概估', s, l, v, u, w, c)}
  ...
  if (embedded) {
    return (
      <div className="space-y-4">
        ...
        {/* 計算器區域 */}
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">{renderCalculator()}</div>
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* 計算器區域 */}
          <div className="bg-gray-50 rounded-2xl p-5">{renderCalculator()}</div>
