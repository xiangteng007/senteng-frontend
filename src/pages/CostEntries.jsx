    ...
    <div className="p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mt-1 text-sm text-gray-500">
              ...
              <span
                className={`px-2 py-0.5 rounded-full text-xs bg-${category.color}-100 text-${category.color}-700`}
              >
                {category.label}
              </span>
            </div>
        ...
        <div className="text-right">
          <p className="text-lg font-bold text-gray-900">${entry.amount?.toLocaleString() || 0}</p>
