  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">將 ERP 的行事曆與聯絡人同步至 Google，方便手機查看</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <TitledCard title="Google 連結狀態">
          <div className="space-y-1">
            <StatusRow
              ...
              value={
                <span
                  className={`font-medium ${status?.connected ? 'text-green-600' : 'text-gray-400'}`}
                >
        ...
        <TitledCard title="行事曆同步設定">
          {canSetCalendar && (
            <div className="mb-4">
              <label className="block text-sm text-gray-600 mb-2">目標日曆 ID</label>
              <input
                type="text"
                value={calendarId}
              ...
              />
              <p className="text-xs text-gray-400 mt-1">留空表示使用主日曆 (primary)</p>
            </div>
          )}
        ...
        <TitledCard title="聯絡人同步設定">
          {canSetLabel && (
            <div className="mb-4">
              <label className="block text-sm text-gray-600 mb-2">聯絡人標籤</label>
              <input
                type="text"
                value={contactsLabel}
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent"
              />
              <p className="text-xs text-gray-400 mt-1">同步至 Google 聯絡人時使用的分類標籤</p>
            </div>
          )}
