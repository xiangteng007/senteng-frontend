      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 flex gap-3">
        ...
        <div className="text-sm text-blue-800">
          ...
          <p className="text-blue-600">
            輸入金額後，系統會自動計算稅額並顯示發票填寫示意圖，幫助您正確填寫手開發票。
          </p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3
                  className={`text-lg font-bold ${invoiceType === 'triple' ? 'text-blue-800' : 'text-green-800'}`}
                >
            ...
            <div className="bg-white rounded-xl p-4 space-y-4 font-mono text-sm">
              ...
              {invoiceType === 'triple' && (
                <div className="grid grid-cols-2 gap-4 pb-3 border-b border-dashed border-gray-300">
                  ...
                  <div>
                    ...
                    <div className="font-bold truncate">{buyerName || '________________'}</div>
                  </div>
                </div>
              )}
              ...
              <div className="pb-3 border-b border-dashed border-gray-300">
                ...
                <div className="font-medium">{itemName || '________________________'}</div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div
                  className={`flex justify-between pt-2 ${invoiceType === 'triple' ? 'border-t border-gray-200' : ''}`}
                >
