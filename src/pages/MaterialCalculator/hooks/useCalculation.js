 ...
 * 計算柱鋼筋 (主筋 + 箍筋)
 */
export const calculateColumnRebar = (height, count, mainBarSize, mainBarCount, stirrupSize, stirrupSpacing, perimeter) => {
 ...
 * 計算梁鋼筋 (上筋 + 下筋 + 箍筋)
 */
export const calculateBeamRebar = (length, count, topSize, topCount, bottomSize, bottomCount, stirrupSize, stirrupSpacing, perimeter) => {
