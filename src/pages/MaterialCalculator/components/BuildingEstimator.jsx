            ...
            <div className="bg-white rounded-xl p-4 border border-gray-100 space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <ResultDisplay
                        ...
                        unit="kg"
                        showWastage={false}
                        onAddRecord={onAddRecord ? () => onAddRecord('建築概估', '鋼筋', totalRebar, 'kg', totalRebar) : null}
                    />
                    <ResultDisplay
                        label="混凝土用量"
                        ...
                        unit="m³"
                        showWastage={false}
                        onAddRecord={onAddRecord ? () => onAddRecord('建築概估', '混凝土', totalConcrete, 'm³', totalConcrete) : null}
                    />
                    <ResultDisplay
                        label="模板面積"
                        ...
                        unit="m²"
                        showWastage={false}
                        onAddRecord={onAddRecord ? () => onAddRecord('建築概估', '模板', totalFormwork, 'm²', totalFormwork) : null}
                    />
                    <ResultDisplay
                        label="砂石用量"
                        ...
                        unit="m³"
                        showWastage={false}
                        onAddRecord={onAddRecord ? () => onAddRecord('建築概估', '砂石', totalSand, 'm³', totalSand) : null}
                    />
                </div>
            </div>
                    ...
                    <table className="min-w-full text-xs">
                        ...
                        <tbody>
                            {filteredTypes.map((t, i) => (
                                <tr key={i} className={`border-b border-gray-50 ${t.originalIndex === validSelectedIndex ? 'bg-orange-50' : ''}`}>
