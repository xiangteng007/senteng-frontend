...
const BuildingEstimator = ({ onAddRecord, buildingTypes = [] }) => {
  ...
  const selected = buildingTypes[validSelectedIndex] ||
    buildingTypes[0] || { rebar: 0, concrete: 0, formwork: 0, sand: 0 };
      ...
      <div className="bg-white rounded-xl p-4 border border-gray-100 space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <ResultDisplay
            ...
            onAddRecord={
              onAddRecord
                ? () => onAddRecord('建築概估', '鋼筋', totalRebar, 'kg', totalRebar)
                : null
            }
          />
          <ResultDisplay
            ...
            onAddRecord={
              onAddRecord
                ? () => onAddRecord('建築概估', '混凝土', totalConcrete, 'm³', totalConcrete)
                : null
            }
          />
          <ResultDisplay
            ...
            onAddRecord={
              onAddRecord
                ? () => onAddRecord('建築概估', '模板', totalFormwork, 'm²', totalFormwork)
                : null
            }
          />
          <ResultDisplay
            ...
            showWastage={false}
            onAddRecord={
              onAddRecord ? () => onAddRecord('建築概估', '砂石', totalSand, 'm³', totalSand) : null
            }
          />
        </div>
      </div>
