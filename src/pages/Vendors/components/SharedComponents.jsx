...
import {
    Star, HardHat, Building, Wrench, Tag, ChevronRight,
    Trash2, User, ThumbsUp, ThumbsDown, MessageSquare
} from 'lucide-react';
...
export const ReviewItem = ({ review }) => (
    <div className="flex gap-3 p-3 bg-gray-50 rounded-lg">
        <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${review.sentiment === 'positive' ? 'bg-green-100' :
