        ...
        <div className="flex-1 grid grid-cols-7 auto-rows-fr">
          {days.map((day, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`border-b border-r border-gray-50 p-2 min-h-[100px] transition-colors ${
                  !day ? 'bg-gray-50/20' : 'hover:bg-gray-50'
                    ...
                    <div className="space-y-1">
                      {events.map(evt => (
                        <div
                          ...
                          className={`text-[10px] px-2 py-1 rounded-lg border truncate cursor-pointer ${
                            evt.type === 'loan'
...
// Re-export as Calendar for compatibility
