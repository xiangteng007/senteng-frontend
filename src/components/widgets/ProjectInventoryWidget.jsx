                  ...
                  {groupedByDate[date].map((item, idx) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-1">
                        <div className="flex items-center gap-2">
                          <span
                            className={`px-1.5 py-0.5 rounded text-xs border flex items-center gap-1 ${getTypeColor(item.type)}`}
                          >
                      ...
                      <div className="text-xs text-gray-400 mt-1">操作人：{item.operator}</div>
                    </div>
                  ))}
                </div>
              </div>
