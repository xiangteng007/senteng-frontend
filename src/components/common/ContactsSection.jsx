...
export function ContactsSection({
  ...
  const handleSyncAll = async () => {
    ...
    try {
      const syncFn =
        entityType === 'client' ? syncClientContactsToGoogle : syncVendorContactsToGoogle;
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
      ...
      {contacts.length > 0 ? (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                ...
                <th className="text-left py-2 px-3 text-gray-500 font-medium hidden sm:table-cell">
                  Email
                </th>
                <th className="text-left py-2 px-3 text-gray-500 font-medium hidden md:table-cell">
                  職稱
                </th>
                  ...
                  <td className="py-3 px-3 text-center">
                    {canSyncContact && (
                      <button
                        ...
                        title={
                          !isGoogleConnected ? '請先連結 Google 帳號' : '同步至 Google Contacts'
                        }
                      >
                        {syncingId === contact.id ? (
        ...
        <div className="text-center py-8 text-gray-400 text-sm">尚無聯絡人資料</div>
      )}
